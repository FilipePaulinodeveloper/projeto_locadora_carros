  ...
  <form @submit.prevent="submit">
    <section class="mt-6 bg-white rounded-sm p-10 shadow-sm" v-if="currentNav == 1">
      ...
      <div class="mt-10 grid grid-cols-1 gap-6 max-md:grid-cols-1">
        ...
        <div>
        <span class="p-float-label">
            <Dropdown v-model="form.estado" class="w-full" required maxlength="2" :options="statesOptions" optionLabel="name" dataKey="value" />
...
function submit() {
  form.data_nascimento = formatDateForDatabase(form.data_nascimento)
  validateForm();
  submited.value = true;
