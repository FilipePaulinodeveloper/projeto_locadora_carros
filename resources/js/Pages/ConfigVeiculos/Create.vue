    ...
    <form @submit.prevent="submit">
        <section class="mt-6 bg-white rounded-sm p-10 shadow-sm" v-if="currentNav == 1">
            ...
            <div class="mt-10 grid grid-cols-1 gap-6 max-md:grid-cols-1">
                ...
                <div>
                    <span class="p-float-label">
                        <Dropdown class="w-full" v-model="form.combustivel" :options="tiposCombustivel" optionLabel="name"
                        dataKey="value" required />
                ...
                <div>
                    <span class="p-float-label">
                        <Dropdown class="w-full" v-model="form.disponivel_venda" :options="verdadeiroEFalso" optionLabel="name"
                            dataKey="value" required />
                ...
                <div>
                    <span class="p-float-label">
                        <Dropdown class="w-full" v-model="form.disponivel_locacao" :options="verdadeiroEFalso" optionLabel="name"
                        dataKey="value" required />
