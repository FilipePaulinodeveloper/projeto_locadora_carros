                ...
                <div class="flex ml-4  grid grid-cols-8 gap-8 max-md:grid-cols-1">
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.tipo" id="tipo" type="text" class="w-full" required />
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.ano_fabricacao" id="ano_fabricacao" type="text" class="w-full"
                                required />
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.ano_modelo" id="ano_modelo" type="text" class="w-full" required />
                            <label for="ano_modelo" class="text-sm">Ano Modelo</label>
                        </span>
                    </div>
                    <div>
                        <span class="p-float-label">
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.renavam" id="renavam" type="text" class="w-full" required />
                            <label for="renavam" class="text-sm">Renavam</label>
                        </span>
                    </div>
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.chassi" id="chassi" type="text" class="w-full" required />
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.quilometragem" id="quilometragem" type="text" class="w-full"
                                required />
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.categoria" id="categoria" type="text" class="w-full" required />
                            <label for="categoria" class="text-sm">Categoria</label>
                        </span>
                    </div>
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.combustivel" id="combustivel" type="text" class="w-full"
                                required />
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.valor_venda" id="valor_venda" type="text" class="w-full"
                                required />
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.valor_diaria" id="valor_diaria" type="text" class="w-full"
                                required />
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.disponivel_venda" id="disponivel_venda" type="text" class="w-full"
                                required />
                    ...
                    <div>
                        <span class="p-float-label">
                            <InputText v-model="form2.disponivel_locacao" id="disponivel_locacao" type="text"
                ...
                <div class="space-x-6 flex ml-4 grid grid-cols-6 gap-6 max-md:grid-cols-1">
                    ...
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true"
                            v-model="formColumns['columns']['ano_fabricacao']" />
                        <span>Ano de Fabricação</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true"
                            v-model="formColumns['columns']['ano_modelo']" />
                    ...
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['renavam']" />
                        <span>Renavam</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['chassi']" />
                        <span>Chassi</span>
                    </div>
                    <div class="flex items-center space-x-2">
                    ...
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true"
                            v-model="formColumns['columns']['quilometragem']" />
                        <span>Quilometragem</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true"
                            v-model="formColumns['columns']['categoria']" />
                        <span>Categoria</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true"
                            v-model="formColumns['columns']['combustivel']" />
                        <span>Combustível</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true"
                            v-model="formColumns['columns']['valor_venda']" />
                    ...
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true"
                            v-model="formColumns['columns']['disponivel_venda']" />
                        <span>Disponível para Venda</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true"
                            v-model="formColumns['columns']['disponivel_locacao']" />
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead class=" mb-24">
                            <tr class="text-gray-500 font-bold select-none" @click="setParams">
                                ...
                                <th v-if="formColumns.columns.tipo" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'ano_modelo', sorting: sortTable(sortVal.tipo) ? sortVal.tipo = 1 : sortVal.tipo = 0 }">
                                    <div class="flex">
                                ...
                                <th v-if="formColumns.columns.marca" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'ano_modelo', sorting: sortTable(sortVal.marca) ? sortVal.marca = 1 : sortVal.marca = 0 }">
                                    <div class="flex">
                                ...
                                <th v-if="formColumns.columns.ano_fabricacao" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'ano_modelo', sorting: sortTable(sortVal.ano_fabricacao) ? sortVal.ano_fabricacao = 1 : sortVal.ano_fabricacao = 0 }">
                                    <div class="flex">
                                        <span class="group-hover:text-indigo-800">Ano Fabricação</span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <th v-if="formColumns.columns.ano_modelo" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'ano_modelo', sorting: sortTable(sortVal.ano_modelo) ? sortVal.ano_modelo = 1 : sortVal.ano_modelo = 0 }">
                                    <div class="flex">
                                        <span class="group-hover:text-indigo-800">Ano Modelo</span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <th v-if="formColumns.columns.renavam" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'renavam', sorting: sortTable(sortVal.renavam) ? sortVal.renavam = 1 : sortVal.renavam = 0 }">
                                    <div class="flex">
                                        <span class="group-hover:text-indigo-800">Renavam</span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <th v-if="formColumns.columns.chassi" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'chassi', sorting: sortTable(sortVal.chassi) ? sortVal.chassi = 1 : sortVal.chassi = 0 }">
                                    <div class="flex">
                                        <span class="group-hover:text-indigo-800">Chassi</span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <th v-if="formColumns.columns.combustivel" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'combustivel', sorting: sortTable(sortVal.combustivel) ? sortVal.combustivel = 1 : sortVal.combustivel = 0 }">
                                    <div class="flex">
                                        <span class="group-hover:text-indigo-800">Combustível</span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <th v-if="formColumns.columns.valor_venda" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'valor_venda', sorting: sortTable(sortVal.valor_venda) ? sortVal.valor_venda = 1 : sortVal.valor_venda = 0 }">
                                    <div class="flex">
                                        <span class="group-hover:text-indigo-800">Valor Venda</span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <th v-if="formColumns.columns.valor_diaria" scope="col"
                                    ...
                                    <div class="flex">
                                        <span class="group-hover:text-indigo-800">Valor Diária</span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <th v-if="formColumns.columns.disponivel_venda" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'disponivel_venda', sorting: sortTable(sortVal.disponivel_venda) ? sortVal.disponivel_venda = 1 : sortVal.disponivel_venda = 0 }">
                                    <div class="flex">
                                        <span class="group-hover:text-indigo-800">Disponível Venda</span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <th v-if="formColumns.columns.disponivel_locacao" scope="col"
                                    class="px-4 text-sm cursor-pointer text-center border-r group"
                                    @click="orderBy = { column: 'disponivel_locacao', sorting: sortTable(sortVal.disponivel_locacao) ? sortVal.disponivel_locacao = 1 : sortVal.disponivel_locacao = 0 }">
                                    <div class="flex">
                                        <span class="group-hover:text-indigo-800">Disponível Locação</span>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <th scope="col" class="px-3 py-3.5 text-center text-sm sm:pr-12" style="width: 5%;"
                                    v-if="$page.props.userPermissions.includes('edit.ConfigVeiculos') || $page.props.userPermissions.includes('delete.ConfigVeiculos')">
                                    Ações</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 bg-white">
                            <tr v-for="(data, key) in dataTable?.data" :key="key" class="hover:bg-indigo-50/20"
                                ...
                                <td v-if="formColumns?.columns?.tipo"
                                ...
                                <td v-if="formColumns?.columns?.ano_modelo"
                                    class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="font-medium text-gray-900">{{ data?.ano_modelo }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td v-if="formColumns?.columns?.renavam"
                                    class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="font-medium text-gray-900">{{ data?.renavam }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td v-if="formColumns?.columns?.chassi"
                                    class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="font-medium text-gray-900">{{ data?.chassi }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td v-if="formColumns?.columns?.combustivel"
                                    class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="font-medium text-gray-900">{{ data?.combustivel }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td v-if="formColumns?.columns?.valor_venda"
                                    class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="font-medium text-gray-900">{{ data?.valor_venda }}</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td v-if="formColumns?.columns?.disponivel_venda"
                                    class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="font-medium text-gray-900">{{ data?.disponivel_venda }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td v-if="formColumns?.columns?.disponivel_locacao"
                                    class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="font-medium text-gray-900">{{ data?.disponivel_locacao }}</div>
                                        </div>
                                    </div>
                                </td>
...
const formColumns = useForm({
    ...
    columns: {
        ...
        ano_modelo: validateColumnsVisibility("ano_modelo"),
        placa: validateColumnsVisibility("placa"),
        renavam: validateColumnsVisibility("renavam"),
        chassi: validateColumnsVisibility("chassi"),
        cor: validateColumnsVisibility("cor"),
        quilometragem: validateColumnsVisibility("quilometragem"),
        categoria: validateColumnsVisibility("categoria"),
        combustivel: validateColumnsVisibility("combustivel"),
        valor_venda: validateColumnsVisibility("valor_venda"),
        valor_diaria: validateColumnsVisibility("valor_diaria"),
        disponivel_venda: validateColumnsVisibility("disponivel_venda"),
        disponivel_locacao: validateColumnsVisibility("disponivel_locacao"),
    },
});
...
const form2 = useForm({
    ...
    ano_modelo: props.Filtros?.ano_modelo || null,
    placa: props.Filtros?.placa || null,
    renavam: props.Filtros?.renavam || null,
    chassi: props.Filtros?.chassi || null,
    cor: props.Filtros?.cor || null,
    quilometragem: props.Filtros?.quilometragem || null,
    categoria: props.Filtros?.categoria || null,
    combustivel: props.Filtros?.combustivel || null,
    valor_venda: props.Filtros?.valor_venda || null,
    valor_diaria: props.Filtros?.valor_diaria || null,
    disponivel_venda: { value: props.Filtros?.disponivel_venda || '0' },
    disponivel_locacao: { value: props.Filtros?.disponivel_locacao || '0' },
    limparFiltros: '',
});
