		...
		<SlideUpDown v-model="FiltroAvancado" :duration="300">
			<form @submit.prevent="submit">
				<div class="flex ml-4  grid grid-cols-8 gap-8 max-md:grid-cols-1">
                    ...
                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.data_nascimento" id="data_nascimento" type="date" class="w-full" />
                    ...
                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.telefone" id="telefone" type="text" class="w-full" />
                    ...
                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.email" id="email" type="email" class="w-full" />
                    ...
                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.token" id="token" type="text" class="w-full" required />
                    ...
                    <div>
                    <span class="p-float-label">
                        <select v-model="form2.deleted" id="deleted" class="w-full">
                        <option :value="true">Sim</option>
                        <option :value="false">Não</option>
                        </select>
                        <label for="deleted" class="text-sm">Deletado</label>
                    </span>
                    </div>

                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.logradouro" id="logradouro" type="text" class="w-full" required />
                    ...
                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.numero" id="numero" type="text" class="w-full" required />
                    ...
                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.complemento" id="complemento" type="text" class="w-full" />
                    ...
                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.bairro" id="bairro" type="text" class="w-full" required />
                    ...
                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.cep" id="cep" type="text" class="w-full" required />
                    ...
                    <div>
                    <span class="p-float-label">
                        <InputText v-model="form2.cidade" id="cidade" type="text" class="w-full" required />
                    ...
                    <div>
						<span class="p-float-label">
							<InputText v-model="form2.estado" id="estado" type="text" class="w-full" required />
		...
		<SlideUpDown v-model="toggleFilter" :duration="300">
			...
			<div class="text-sm text-gray-500 flex items-center">
				<div class="space-x-6 flex ml-4 grid grid-cols-6 gap-6 max-md:grid-cols-1">
                    ...
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['data_nascimento']" />
                    ...
                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['token']" />
                        <span>Token</span>
                    </div>

                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['deleted']" />
                        <span>Deletado</span>
                    </div>

                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['logradouro']" />
                        <span>Logradouro</span>
                    </div>

                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['numero']" />
                        <span>Número</span>
                    </div>

                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['complemento']" />
                        <span>Complemento</span>
                    </div>

                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['bairro']" />
                        <span>Bairro</span>
                    </div>

                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['cep']" />
                        <span>CEP</span>
                    </div>

                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['cidade']" />
                        <span>Cidade</span>
                    </div>

                    <div class="flex items-center space-x-2">
                        <Checkbox @change="toggleColumns" :binary="true" v-model="formColumns['columns']['estado']" />
                        <span>Estado</span>
                    </div>
					...
					<table class="min-w-full divide-y divide-gray-300">
						<thead class=" mb-24">
							<tr class="text-gray-500 font-bold select-none" @click="setParams">
                                ...
                                class="px-4 text-sm cursor-pointer text-center border-r group"
                                @click="orderBy = { column: 'cpf', sorting: sortTable(sortVal.cpf) ? sortVal.cpf = 1 : sortVal.cpf = 0 }">
                                <div class="flex">
                                ...
                                <th v-if="formColumns.columns.data_nascimento" scope="col"
                                class="px-4 text-sm cursor-pointer text-center border-r group"
                                @click="orderBy = { column: 'data_nascimento', sorting: sortTable(sortVal.data_nascimento) ? sortVal.data_nascimento = 1 : sortVal.data_nascimento = 0 }">
                                <div class="flex">
                                    <span class="group-hover:text-indigo-800">Data de Nascimento</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12" />
                                    </svg>
                                ...
                                <th v-if="formColumns.columns.cidade" scope="col"
                                class="px-4 text-sm cursor-pointer text-center border-r group"
                                @click="orderBy = { column: 'cidade', sorting: sortTable(sortVal.cidade) ? sortVal.cidade = 1 : sortVal.cidade = 0 }">
                                <div class="flex">
                                    <span class="group-hover:text-indigo-800">Cidade</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12" />
                                    </svg>
                                ...
                                <th v-if="formColumns.columns.estado" scope="col"
                                class="px-4 text-sm cursor-pointer text-center border-r group"
                                @click="orderBy = { column: 'estado', sorting: sortTable(sortVal.estado) ? sortVal.estado = 1 : sortVal.estado = 0 }">
                                <div class="flex">
                                    <span class="group-hover:text-indigo-800">Estado</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-auto group-hover:text-indigo-800" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12" />
                                    </svg>
            ...
            <path stroke-linecap="round" stroke-linejoin="round" d="M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12" />
						...
						<tbody class="divide-y divide-gray-200 bg-white">
							<tr v-for="(data, key) in dataTable?.data" :key="key" class="hover:bg-indigo-50/20"
                                ...
                                <td v-if="formColumns?.columns?.data_nascimento"
                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                <div class="flex items-center">
                                    <div>
                                ...
                                <td v-if="formColumns?.columns?.logradouro"
                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                <div class="flex items-center">
                                    <div>
                                    <div class="font-medium text-gray-900">{{ data?.logradouro }}</div>
                                    </div>
                                </div>
                                </td>

                                <td v-if="formColumns?.columns?.numero"
                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                <div class="flex items-center">
                                    <div>
                                    <div class="font-medium text-gray-900">{{ data?.numero }}</div>
                                    </div>
                                </div>
                                </td>

                                <td v-if="formColumns?.columns?.complemento"
                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                <div class="flex items-center">
                                    <div>
                                    <div class="font-medium text-gray-900">{{ data?.complemento }}</div>
                                    </div>
                                </div>
                                </td>

                                <td v-if="formColumns?.columns?.bairro"
                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                <div class="flex items-center">
                                    <div>
                                    <div class="font-medium text-gray-900">{{ data?.bairro }}</div>
                                    </div>
                                </div>
                                </td>

                                <td v-if="formColumns?.columns?.cep"
                                class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                <div class="flex items-center">
                                    <div>
                                    <div class="font-medium text-gray-900">{{ data?.cep }}</div>
                                    </div>
                                </div>
                                </td>
...
const formColumns = useForm({
  ...
  columns: {
    ...
    data_nascimento: validateColumnsVisibility("data_nascimento"),
    telefone: validateColumnsVisibility("telefone"),
    email: validateColumnsVisibility("email"),
    token: validateColumnsVisibility("token"),
    deleted: validateColumnsVisibility("deleted"),
    logradouro: validateColumnsVisibility("logradouro"),
    numero: validateColumnsVisibility("numero"),
    complemento: validateColumnsVisibility("complemento"),
    bairro: validateColumnsVisibility("bairro"),
    cep: validateColumnsVisibility("cep"),
    cidade: validateColumnsVisibility("cidade"),
    estado: validateColumnsVisibility("estado"),
...
const form2 = useForm({
  ...
  deleted: props.Filtros?.deleted || false,
  logradouro: props.Filtros?.logradouro || null,
  numero: props.Filtros?.numero || null,
  complemento: props.Filtros?.complemento || null,
  bairro: props.Filtros?.bairro || null,
  cep: props.Filtros?.cep || null,
  cidade: props.Filtros?.cidade || null,
