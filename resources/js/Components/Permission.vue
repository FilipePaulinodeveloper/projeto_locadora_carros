        ...
        <div class="w-full mx-auto bg-white rounded-sm border border-gray-200">
          ...
          <h2>Permissões</h2>
            <div class="ml-auto space-x-2 items-center text-sm">
              <Checkbox id="selectAll" @click="markAll(range(1, 373))" v-model="selectedAll" placeholder="Select all" class="ml-auto" :binary="true" />
...
<!-- #ModificaAqui -->
                ...
                <tr>
                        <td class='p-2 whitespace-nowrap'>
                        <div class='flex items-center'>
                            <div class='font-medium text-gray-800'>Veiculos</div>
                        </div>
                        </td>
                        <td class='p-2 text-center'>
                ...
                <tr>
                        <td class='p-2 whitespace-nowrap'>
                        <div class='flex items-center'>
                            <div class='font-medium text-gray-800'>Manutenções</div>
                        </div>
                        </td>
                        <td class='p-2 text-center'>
                ...
                <tr>
                        <td class='p-2 whitespace-nowrap'>
                        <div class='flex items-center'>
                            <div class='font-medium text-gray-800'>Funcionarios</div>
                        </div>
                        </td>
                        <td class='p-2 text-center'>
