...
class updateVeiculoRequest extends FormRequest
{
    ...
    {
        $veiculo = ConfigVeiculo::where('token', $this->id)->first();
        return [
            ...
            'placa' => [
                'required',
                 'string',
                 'max:20',
                 Rule::unique('config_veiculos', 'placa')->ignore($veiculo->id)
            ],
            'renavam' => [
                'required',
                'string',
            ...
            'chassi' => [
                ...
                'string',
                'max:50',
                Rule::unique('config_veiculos', 'chassi')->ignore($veiculo->id)
            ],
